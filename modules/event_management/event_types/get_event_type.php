...
try {
    ...
    if (isset($_GET["eventTypeId"]) && is_numeric($_GET["eventTypeId"])) {
        ...
        throw new Exception("Veranstaltungskategorie mit der id '$eventTypeId' konnte nicht abgerufen werden.", 404);
    }
    ...
    echo json_encode(array("status" => "error", "message" => "Veranstaltung mit der id $eventTypeId konnte nicht abgerufen werden."));
    exit;
}
