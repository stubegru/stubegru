class EventInstanceController {
    ...
    static async handleUpdateEventInstance(jsonString) {
        try {
    ...
    static async handleCreateEventInstance(jsonString) {
        try {
    ...
    static async handleDeleteEventInstance(eventInstanceId) {
        try {
...
EventInstanceController.eventInstanceList = {};
