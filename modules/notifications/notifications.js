...
<ul class="dropdown-menu dropdown-messages" id="notificationDropdownList">
  ...
  <li>
    ...
    //refresh notification list after re-rendering menubar
    stubegru.modules.menubar.registerPostRenderHook("-update notifications-", renderNotificationDropdown, -10);
    stubegru.modules.menubar.registerPostRenderHook("-update notification dropdown listener-", registerNotificationDropdownListener, 0);
...
function registerNotificationDropdownListener() {
...
function renderNotificationDropdown() {
    if (!stubegru.modules.notifications.list){
        return false;
    }
    
    let notificationList = stubegru.modules.notifications.list;
    let unreadCounter = 0;
