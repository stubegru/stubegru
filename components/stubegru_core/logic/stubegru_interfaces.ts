...
export interface StubegruCustomConfig {
  ...
  selfServiceMaxMeetingsByIp: number;
  selfServiceMaxMeetingsByIpSeconds: number;
  selfServiceMaxMeetingsByIpExpireDays: number;
  selfServiceMaxMeetingsByMail: number;
  selfServiceMaxMeetingsByMailDays: number;
  selfServiceMaxMeetingsByMailExpireDays: number;
  selfServiceKeepLogDays: number;
}
