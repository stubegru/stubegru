...
export default class MeetingController {
    ...
    async openFreeMeeting(meetingId) {
        ...
        if (resp.isBlocked) { m.setInfoAlert(`Dieser Termin wird bereits von einem anderen Nutzer bearbeitet. Daher kann dieser Termin aktuell nicht vergeben werden.<br> Der Termin ist aktuell gesperrt durch: ${resp.blockName}.`); }
