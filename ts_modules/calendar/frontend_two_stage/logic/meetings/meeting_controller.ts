...
export default class MeetingController {
    ...
    async openFreeMeeting(meetingId) {
        ...
        if (resp.isBlocked) { m.setInfoAlert(`Dieser Termin ist gerade von einer anderen Person ausgewählt worden. Daher kann dieser Termin aktuell nicht vergeben werden.<br> Der Termin ist aktuell gesperrt durch: ${resp.blockName}.`); }
