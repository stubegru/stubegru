...
export default class MeetingController {
    ...
    async openFreeMeeting(meetingId) {
        ...
        if (resp.isBlocked) { m.setInfoAlert(`Dieser Termin wird aktuell von einem anderen Nutzer bearbeitet. Daher kann dieser Termin aktuell nicht vergeben werden. Bitte buchen Sie einen anderen Termin oder versuchen Sie es zu einem späteren Zeitpunkt nochmal!`); }
