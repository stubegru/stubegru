...
import { AssignClientResponse, MeetingClient } from "../meeting_clients/meeting_client_service.js";
...
export default class MeetingClientView {
  ...
  */
    ...
    showAssignmentFeedback(statusObject: AssignClientResponse) {
        if (statusObject.status == "error") {
            ...
            if (phone) { errorMsg += ` Sollte das Problem weiterhin auftreten, vereinbaren Sie bitte einen Termin über unsere Hotline <b>${phone}</b>.`; }
