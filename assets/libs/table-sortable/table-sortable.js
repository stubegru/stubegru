...
!function (t) {
    ...
    , function (t, e, n) {
        ...
        var s, l = n(0), u = n.n(l), c = function (t) {
            ...
            if ("[object Date]" === Object.prototype.toString.call(t) && !isNaN(t))
                return !0;
            if (p(t)) {
                var e = new Date(t);
                if (h(e.getDate()))
            ...
            if (y(c(t), "ForEach requires array input"),
                !t.length)
                return [];
            f(e) || (e = function () { }
            );
            ...
            if (y(c(t), "_filter requires array input"),
                !t.length)
                return [];
            if (!f(e))
                return t;
            for (var n = 0, a = t.length, i = []; n < a;)
                e.apply(null, [t[n], n]) && i.push(t[n]),
                    n += 1;
            return i
        }, y = function (t, e) {
            var n;
            ...
            return o(t, [{
                ...
                key: "fromCollection",
                value: function (t) {
                    this._formatError(c(t), "fromCollection", "Requires dataset to be a collection, like [{ }]"),
                        this.dataset = t,
                ...
                key: "top",
                value: function (t) {
                    return this._hasDataset(),
                        t ? (this._formatError(h(t), "top", "Requires length to be a number"),
                            this.dataset.slice(0, t)) : this.dataset.slice(0, this._outLen)
                }
            }, {
                key: "bottom",
                value: function (t) {
                    return this._hasDataset(),
                        t ? (this._formatError(h(t), "bottom", "Requires length to be a number"),
                            t = Math.max(this._datasetLen - t, 0),
                            this.dataset.slice(t, this._datasetLen)) : (t = Math.max(this._datasetLen - this._outLen, 0),
                ...
                value: function (t, e) {
                    return this._hasDataset(),
                        this._formatError(h(t), "get", 'Requires "from" to be a number'),
                        this._formatError(h(e), "get", 'Requires "to" to be a number'),
                ...
                value: function (t, e) {
                    this._hasDataset(),
                        this._formatError(p(t), "sort", 'Requires "column" type of string'),
                        this._formatError(p(e), "sort", 'Requires "direction" type of string'),
                        this._formatError("asc" === e || "desc" === e, "sort", '"%s" is invalid sort direction. Use "dataset.sortDirection.ASC" or "dataset.sortDirection.DESC".', e);
                    var n = this.top(1)[0];
                    return this._formatError("undefined" !== typeof n[t], "sort", 'Column name "%s" does not exist in collection', t),
                        this.sortDirection.ASC === e ? this.dataset.sort((function (e, n) {
                            return P(e[t], n[t])
                        }
            ...
            return function (t, e) {
                ...
                for (var n = Object.keys(e), a = 0; a < n.length;) {
                    var i = n[a]
                        , r = e[i];
                    void 0 !== r && (/^on/.test(i) && r ? t.on(i.replace(/^on/, "").toLowerCase(), r) : "text" === i ? t.text(r) : "html" === i ? t.html(r) : "append" === i ? t.append(r) : "className" === i ? t.attr("class", r) : t.attr(i, r),
                        a += 1)
                }
                return t
            ...
            if (a || n.empty(),
                ...
                for (var i = [], r = 0; r < e.length; r++) {
                    var o = S(e[r]);
                    e[r].children && (o = t(e[r].children, o, !0)),
                        i.push(o)
                }
                n.append(i)
            } else if (d(e)) {
                var s = S(e);
                e.children && (s = t(e.children, s, !0)),
                    n.append(s)
            }
            return n
        }, L = function () {
            ...
            function () {
                function t(e) {
                    ...
                    i(this, t),
                        ...
                        this.setData = function (t, e, a) {
                            n.logError(c(t), "setData", "expect first argument as array of objects"),
                                n.logError(d(e), "setData", "expect second argument as objects"),
                                n._isMounted && t && (a ? n._dataset.pushData(t) : n._dataset.fromCollection(t),
                                    e && (n.options.columns = e),
                                    n.refresh())
                        }
                        ,
                        ...
                        this.refresh = function (t) {
                            t ? (n.distroy(),
                                n.create()) : n._isMounted && n.updateTable()
                        }
                        ,
                        this.distroy = function () {
                            n._isMounted && (n.emitLifeCycles("tableWillUnmount"),
                                n._table.remove(),
                                n._styles && n._styles.length && (n._styles.remove(),
                                    n._styles = null),
                                n._dataset = null,
                                n._table = null,
                                n._thead = null,
                                n._tbody = null,
                                n._pagination.elm && n._pagination.elm.remove(),
                                n._pagination = {
                                    elm: null,
                                    currentPage: 0,
                                    totalPages: 0,
                                ...
                                n._cachedViewPort = -1,
                                n._cachedOption = null,
                                n.emitLifeCycles("tableDidUnmount"))
                        }
                        ,
                ...
                return o(t, [{
                    ...
                    value: function (t, e) {
                        ...
                        h(t) && w(t, [0, n]) && (this._pagination.currentPage = t,
                    ...
                    value: function (t) {
                        this.logError(h(t), "updateRowsPerPage", "expect argument as number"),
                            t && (this._pagination.currentPage = 0,
                                this.options.rowsPerPage = t,
                                this.updateTable())
                    }
                }, {
                    key: "lookUp",
                    value: function (t) {
                        ...
                        this.logError(e && c(e), "lookUp", "second argument must be array of keys"),
                            e.length || (e = n),
                            this._pagination.currentPage = 0,
                            this._dataset.lookUp(t, m(e)),
                    ...
                    value: function (t) {
                        ...
                        var e = this._sorting
                            ...
                            , a = e.currentCol;
                        t !== a && (n = ""),
                            n ? n === this._dataset.sortDirection.ASC ? n = this._dataset.sortDirection.DESC : n === this._dataset.sortDirection.DESC && (n = this._dataset.sortDirection.ASC) : n = this._dataset.sortDirection.ASC,
                            a = t,
                            this._sorting = {
                                dir: n,
                                currentCol: a
                            },
                            this._dataset.sort(a, n),
                    ...
                    value: function (t, e) {
                        var n = this
                            ...
                            , i = this;
                        return a ? (a && !c(a) && ((t = u()(t)).attr("role", "button"),
                    ...
                    value: function (t) {
                        ...
                        b(o, (function (t, n) {
                            var o = a[t];
                            f(i) && (o = i(a[t], t, n)),
                                o = e._addColSorting(u()("<span></span>").html(o), t);
                    ...
                    value: function (t, e) {
                        ...
                        if (f(o)) {
                            ...
                            this._pagination.currentPage = void 0 !== e ? e : r,
                                this.updateTable()
                    }
                }, {
                    ...
                    value: function (t) {
                        var e = this
                            ...
                            , p = 0
                            , g = Math.min(h, p + f);
                        if (c > f / 2 && c < h - f / 2 ? (p = c - Math.floor(f / 2),
                            g = Math.min(h, p + f)) : c > h - f / 2 && (p = h - f,
                                g = h),
                            t || (t = u()('<div class="gs-pagination"></div>'),
                        ...
                        for (var v = p; v < g;) {
                            var y = n.createElement("button", {
                                ...
                                onClick: function () {
                                    ...
                                    Number.isNaN(t) && (t = parseInt(u()(this).text() - 1)),
                                        e.onPaginationBtnClick(null, t)
                                },
                                text: v + 1,
                                "data-page": v
                            });
                        ...
                        var k = this.getCurrentPageIndex()
                            ...
                            , w = n.createElement("span", {
                                text: `Zeige ${Math.min(E, C + 1)} bis ${E} von ${this._dataset._datasetLen} Zeilen`,
                    ...
                    value: function () {
                        ...
                        if (!n)
                            return !1;
                        this.logError(e && h(e), "rowsPerPage", "should be a number greater than zero."),
                            this.logError(h(a), "totalPages", "should be a number greater than zero.");
                        var i = a || Math.ceil(this._dataset._datasetLen / e);
                        0 >= i && (i = 1),
                            this._pagination.totalPages = i,
                            this._pagination.elm ? this.renderPagination(this._pagination.elm) : this._pagination.elm = this.renderPagination()
                    }
                }, {
                    key: "_generateTable",
                    value: function (t, e) {
                    ...
                    value: function () {
                        if (!this.options.responsive) {
                            var t = u()("<style></style>");
                            t.attr("id", "gs-table"),
                                t.html(".gs-table-container .table{table-layout:fixed}@media(max-width:767px){.gs-table-container{overflow:auto;max-width:100%}}"),
                                u()("head").append(t),
                                this._styles = t
                        }
                    }
                    ...
                    key: "updateTable",
                    value: function () {
                        this._isUpdating || (this.emitLifeCycles("tableWillUpdate"),
                            this._isUpdating = !0,
                    ...
                    value: function () {
                        this._isUpdating || (this._isUpdating = !0,
                    ...
                    key: "makeResponsive",
                    value: function () {
                        var t, e = this.options.responsive, n = window.innerWidth, a = _(m(e), "desc");
                        if (this.logError(d(e), "responsive", 'Invalid type of responsive option provided: "%s"', e),
                            b(a, (function (e) {
                                parseInt(e, 10) > n && (t = e)
                            }
                            )),
                            ...
                            this._cachedViewPort = t;
                            var i = e[t];
                            d(i) ? (this._cachedOption || (this._cachedOption = u.a.extend({}, this.options)),
                                this.options = u.a.extend(this.options, i),
                                this.refresh()) : this._cachedOption && (this.options = u.a.extend({}, this._cachedOption),
                                    this._cachedOption = null,
                                    this._cachedViewPort = -1,
                                    this.refresh())
                        }
        ...
        window.Pret = L(),
            window.TableSortable = O,
            window.DataSet = D,
            (s = jQuery).fn.tableSortable = function (t) {
                return t.element = s(this),
                    new window.TableSortable(t)
            }
            ;
        e.default = O
    }
